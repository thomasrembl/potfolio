  ...
  return (
    <section className="project-detail">
      ...
      <div className="project-text">
        {project.translation[activeLocale]?.informationText && (
        ...
        {project.translation[activeLocale]?.descriptionText && (
      ...
      {project.linkUrl && project.linkUrl.length > 0 && (
